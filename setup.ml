...
(* OASIS_START *)
(* DO NOT EDIT (digest: 75a5806394b0a1ffd382e3926e9e5bf8) *)
(*
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Socketio"];
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "socketio";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "socketio_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "socketio"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "socketio_test.ml"; })
            ];
